...
func NewAllowCORSHeader() *CORSHeader {
	...
	//header.AllowCORSHeader["Access-Control-Allow-Origin"] = []string{"http://192.168.1.11:800"}
	...
	header.AllowCORSHeader["Access-Control-Allow-Headers"] = []string{"Origin, X-Requested-With, X-Extra-Header, Content-Type, Accept, Authorization"}
	header.AllowCORSHeader["Access-Control-Allow-Credentials"] = []string{"true"}
